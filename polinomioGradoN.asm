...
#Ingresar los coeficientes(enteros) mediante un bucle
...
loop_coef:
	...
	sw $v0, 0($t5)	#Guarda el valor del coeficiente en la dirección $t5
...
recorrer_coef:
	...
	lw $t6, 0($t5)	# Cargar el coeficiente

	mtc1 $t6, $f4	# Mover el entero al registro de punto flotante
...
skip_pow:
   	...
   	subi $t3, $t3, 1        # Incrementar el índice
